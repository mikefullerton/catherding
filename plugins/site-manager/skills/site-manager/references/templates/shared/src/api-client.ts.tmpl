import type { ProblemDetails, AuthTokens } from "./types.js";
...
async function refreshAccessToken(
  ...
  try {
    ...
    config.setTokens({ accessToken: data.accessToken, refreshToken: data.refreshToken });
    return true;
  } catch {
    return false;
  }
