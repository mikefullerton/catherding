...
summary: "Map of the 19 cookbook principles that guide this repo, grouped by theme, with one-line hooks and links to the policies that apply each one."
...
All 19 principles in the [agenticcookbook](../../../../agenticcookbook/principles/INDEX.md) are in scope for this repo. This file is the map: the cookbook is authoritative for each principle's definition; the **Applied in** cross-links point to the specific policies that concretize the principle in this author's work.
