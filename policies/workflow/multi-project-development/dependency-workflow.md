...
This mirrors the rule in [the Submodule Workflow](../../../.claude/CLAUDE.md) — the consumer MUST NOT point at a SHA that is not reachable from the dependency's published `<branch>`.
