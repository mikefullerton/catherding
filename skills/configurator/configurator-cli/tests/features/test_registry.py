...
class TestDiscoverFeatures:
    ...
    def test_feature_ids(self):
        ...
        assert set(ids) == {"project", "website", "theme", "text_size", "user_settings", "backend", "admin", "dashboard", "auth", "login_tracking", "pausing", "email", "sms", "analytics", "ab_testing", "logging", "credentials"}
