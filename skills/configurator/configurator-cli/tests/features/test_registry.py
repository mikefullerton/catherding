...
class TestDiscoverFeatures:
    ...
    def test_feature_ids(self):
        ...
        assert set(ids) == {"project", "website", "theme", "text_size", "user_settings", "feedback", "backend", "admin", "dashboard", "auth", "login_tracking", "pausing", "capabilities", "email", "sms", "analytics", "ab_testing", "feature_flags", "logging", "credentials", "data_model", "api_view"}
