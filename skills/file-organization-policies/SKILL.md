...
Full rationale in [`~/projects/active/catherding/docs/policies/file-organization.md`](../../docs/policies/file-organization.md). See [INDEX.md](../../docs/policies/INDEX.md) for related policies.
