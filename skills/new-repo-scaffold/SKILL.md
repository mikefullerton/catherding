...
Full rationale and the rest of the standard: `~/projects/active/cat-herding/docs/rules/development-policies.md` (sections: "Every Repo Must Have", "Documentation", "Git").
